...
{
    public:
        FitParameters(const std::string& par_name, bool random_priors = false, bool tkiFit = false, bool fixParameters = false, bool tkiConstraint = false);
        ~FitParameters();
    ...
    private:
        ...
        bool m_TKI_fit;
        bool m_TKI_constraint;
        bool m_fixParameters;
