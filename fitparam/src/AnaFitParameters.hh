...
public:
    ...
    void ThrowPrefit(std::vector<double>& param);
    void GetParPrefit(std::vector<double>& param) const;
    virtual double GetChi2(const std::vector<double>& params) const;
