...
int treeConvert_dptt(TString inFileName="/hepstore/kmtsui/T2K/work/highland2/myNumuCCMultiPiAnalysis/v0r0/output/*.root", TString inTreeName="default",  TString inTreeName_T="truth", TString outFileName="../inputs/neutRun8_new_Bin2_50up_Bin5_50down_Bin6_50up_Bin7_50down_Bin8_50down.root",
                ...
                TString D2NameRec="selmu_mom", TString D2NameTrue="selmu_truemom", TString D2NameTrue_T="truelepton_mom")
{
  ...
  //outFileName="../inputs/neut_prod6D_dataPOT_H.root";
  ...
  //outFileName="../inputs/neut_Run2_8_dataPOT_H.root";
  ...
  TH2D* hist2d = (TH2D*)fHist2d->Get("truthDeltapTT_vs_truepi_mom");
  ...
  TH2D* hist2d_mult = (TH2D*)fHist2d_2->Get("truthDeltapTT_vs_truepi_mom");*/
...
//std::cout<<"accum_level"<<std::endl;
      ...
      //std::cout<<"D2true = "<<D2true<<std::endl;
      //weight = weight*11.53/36.7;//weight = weight*11.53/62.7;

      /*double weightFSI = 1.;
      int pbin = (trueProtonMom[0]-450.)/75.;
      int thetabin = (trueProtonStartDir[0][2]-0.342)/0.0658;
      ...
      weight = weight*weightFSI;*/

      /*double weightMult = 1.;
      int pbin = (truepi_mom-150)/52.5;
      int thetabin = (truthDeltapTT_vtx+700)/70.;
